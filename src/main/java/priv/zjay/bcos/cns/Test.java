...
import priv.zjay.bcos.cns.source.CNSTest;
import priv.zjay.bcos.cns.source.CNSTest.SetEventResponse;
import priv.zjay.bcos.cns.source.CNSTest.SetMsgEventResponse;
import priv.zjay.bcos.cns.source.CNSTest.SetUEventResponse;
...
public class Test {
	...
	public void getMsg(String address) throws InterruptedException, ExecutionException {
		...
		System.out.println("getMsg resuorg.lt = " + result.get().toString());
	}
